...
@Component({
  selector: 'app-location-agent-map',
  templateUrl: './location-agent-map.component.html',
  styleUrls: ['./location-agent-map.component.scss']
})
export class LocationAgentMapComponent implements OnInit {
